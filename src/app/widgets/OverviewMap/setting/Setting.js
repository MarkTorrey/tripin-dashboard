  ...
  function(
    ...
    return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
      ...
      getConfig: function() {
        ...
        this.config.minWidth = parseInt(this.minWidth.get('value'));
        this.config.minHeight = parseInt(this.minHeight.get('value'));
        this.config.maxWidth = parseInt(this.maxWidth.get('value'));
        this.config.maxHeight = parseInt(this.maxHeight.get('value'));
        return this.config;
      }
