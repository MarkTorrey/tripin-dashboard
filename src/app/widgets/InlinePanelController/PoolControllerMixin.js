...
define([
  ...
  'jimu/WidgetManager',
  'jimu/PanelManager'
], function(declare, lang, array, topic, aspect, Deferred, WidgetManager, PanelManager){
  var clazz = declare(null, {
    ...
    //groups: String[]
    //    an array of group label, if not set, do not read any group.
    ...
    getAllConfigs: function(){
      ...
      if(ret.length > 0 && ret[0].index !== undefined){
