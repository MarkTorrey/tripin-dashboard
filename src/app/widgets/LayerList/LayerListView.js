  ...
  return declare([_WidgetBase, _TemplatedMixin], {
    ...
    postCreate: function() {
      array.forEach(this.operLayerInfos.finalLayerInfos, function(layerInfo) {
        ...
        this.drawListNode(layerInfo, 0, this.layersListNode, true);
    ...
    addLayerNode: function(layerInfo, level, toTableNode, hasPopupMenu) {
      ...
      imageShowLegendNode = domConstruct.create('img', {
        ...
        'src': this.layersList.folderUrl + 'images/v_right.png',
        'alt': 'l'
      }, imageShowLegendDiv);
      ...
      imageNoLegendNode = domConstruct.create('img', {
        ...
        'src': this.layersList.folderUrl + 'images/noLegend.png',
        'alt': 'l'
      }, imageNoLegendDiv);
      ...
      //bind event
      on(layerTrNode, 'click', lang.hitch(this, this._onRowTrClick, layerInfo, imageShowLegendNode));
      on(layerTrNode, 'mouseover', lang.hitch(this, this._onLayerNodeMouseover, layerTrNode, imageShowLegendNode, popupMenuNode));
      on(layerTrNode, 'mouseout', lang.hitch(this, this._onLayerNodeMouseout, layerTrNode, imageShowLegendNode, popupMenuNode));
      on(imageShowLegendDiv, 'click', lang.hitch(this, this._onImageShowLegendClick, layerInfo, imageShowLegendNode));
      on(ckSelect.domNode, 'click', lang.hitch(this, this._onCkSelectNodeClick, layerInfo, ckSelect));
      if(hasPopupMenu) {
        on(popupMenuNode, 'click', lang.hitch(this, this._onPopupMenuClick, layerInfo, popupMenu));
        topic.subscribe("popupMenuAll/hide", lang.hitch(this, this._onPopupMenuHide, popupMenu));
      }
      on(this.layersList.domNode.parentNode, "click", lang.hitch(this, this._onLayerListWidgetPaneClick, popupMenu));
...
*/
    ...
    _onImageShowLegendClick: function(layerInfo, imageShowLegendNode, evt) {
      layerInfo.fold(imageShowLegendNode, this.layersList.folderUrl);
      if(evt) {
        evt.stopPropagation();
      }
    ...
    _onPopupMenuClick: function(layerInfo, popupMenu, evt) {
      if (popupMenu.isShow) {
        ...
        if (popupMenu) {
          ...
          //popupMenu.set("layersList", this.layersList);
          popupMenu.show();
        }
      }
      evt.stopPropagation();
