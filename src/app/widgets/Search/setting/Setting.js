...
function(declare, lang, array, html, query, on,json, _WidgetsInTemplateMixin,BaseWidgetSetting,SimpleTable,SingleSearch,NumberTextBox,TextBox,Select,esriRequest) {
  return declare([BaseWidgetSetting,_WidgetsInTemplateMixin], {
    ...
    getConfig:function(){
      this.config.zoomscale = parseInt(this.zoomScale.get('value'));
