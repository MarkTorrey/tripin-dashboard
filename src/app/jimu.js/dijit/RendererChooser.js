...
function(declare, _WidgetBase, _TemplatedMixin,_WidgetsInTemplateMixin, template, lang, html, array, on, query,gfx,Color,Select,ComboBox,NumberSpinner,NumberTextBox,
  ...
  CartographicLineSymbol,SimpleFillSymbol,mainNls) {
  return declare([_WidgetBase, _TemplatedMixin,_WidgetsInTemplateMixin], {
    ...
    _classBreaksColors:{
      color1:['#eaf0fd','#03519e'],color2:['#ebf9e7','#046e2e'],color3:['#f5f5f5','#2a2a2a'],color4:['#ffeddd','#a83a00'],
      color5:['#f2eef6','#582890'],color6:['#ffe3d7','#a71713'],color7:['#ecf7fb','#006d2a'],color8:['#edf8fa','#83067e'],
      color9:['#eef9e8','#0167af'],color10:['#fff1d7','#b80201'],color11:['#f0eef6','#015b90'],color12:['#f5eff7','#006dfa'],
      color13:['#f1eef7','#9c0042'],color14:['#ffebe2','#7d0078'],color15:['#ffffc9','#016a35'],color16:['#ffffcb','#253197'],
      color17:['#fffed1','#9e3601'],color18:['#ffffad','#c20120'],color19:['#a9620d','#038772'],color20:['#d3168c','#46ae1b'],
      color21:['#7c2d96','#048936'],color22:['#eb6300','#603b9b'],color23:['#cc0117','#0471b2'],color24:['#ce0118','#424242'],
      color25:['#db1a10','#287cba'],color26:['#da1baf','#03983e'],color27:['#db1a10','#2483bb']
    },
    ...
    _updateClassBreaksTable:function(){
      ...
      var count = parseInt(this.classCount.get('value'));
