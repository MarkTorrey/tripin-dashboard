...
define(['dojo/_base/declare',
  ...
  'dojo/text!./templates/ServiceBrowser.html',
  'dojo/_base/lang',
  'dojo/_base/html',
  'dojo/_base/array',
  'dojo/on',
...
function(declare, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin,template, lang, html, array, on, all,Memory,
  Observable,ObjectStoreModel,Tree,ComboBox,esriRequest,Message,tokenUtils,LoadingShelter) {
  return declare([_WidgetBase,_TemplatedMixin,_WidgetsInTemplateMixin], {
    ...
    onTaskUrlSelected:function(taskUrl){
    },
    ...
    setUrl:function(url){
      ...
      var pattern = /arcgis\/rest\/services/i;
      if(theUrl.search(pattern) <= 0){
    ...
    _checkSpecifiedServiceNum:function(){
      ...
      if(items.length === 0){
        new Message({
          message:'No geoprocessing services were found.'
        });
      }
    },
    ...
    _showRequestError:function(){
      new Message({
        message:"Unable to connect to "+this._currentUrl
      });
    },
