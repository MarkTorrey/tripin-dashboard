...
function(declare, _WidgetBase, _TemplatedMixin,_WidgetsInTemplateMixin, template, lang, html, array, on, query,gfx,Color,Select,ColorPicker,NumberSpinner,
  esriRequest,jsonUtils,SimpleMarkerSymbol,PictureMarkerSymbol,SimpleLineSymbol,CartographicLineSymbol,SimpleFillSymbol,TextSymbol,Font,mainNls) {
  return declare([_WidgetBase, _TemplatedMixin,_WidgetsInTemplateMixin], {
    ...
    _initPointSection:function(){
      ...
      if (!this._pointEventsBinded) {
        ...
        array.forEach(this.pointSymClassSelect.options, lang.hitch(this, function(option) {
          this._requestPointSymJson(option.value);
        }));
      }
    ...
    _bindPointEvents:function(){
      ...
      this.own(on(this.pointSymClassSelect,'Change',lang.hitch(this,this._showSelectedPointSymIconTable)));
    ...
    _showSelectedPointSymIconTable:function(){
      ...
      query('.marker-icon-table-'+fileName,this.pointIconTables).style('display','table');
    },
    ...
    _initFillSettings:function(symbol){
      ...
      if(symbol.outline){
        ...
        this.fillOutlineWidth.set('value',parseInt(symbol.outline.width));
      }
      this._invokeSymbolChangeEvent = true;
    },
    ...
    _getFillSymbolBySetting:function(){
      ...
      var outlineWidth = parseInt(this.fillOutlineWidth.get('value'));
      this.symbol.setColor(color);
    ...
    _initTextSettings:function(symbol){
      ...
      var size = parseInt(symbol.font.size);
    ...
    _updateTextPreview:function(){
      ...
      var size = parseInt(this.textFontSize.get('value'))+'px';
    ...
    _getTextSymbolBySetting:function(){
      ...
      var size = parseInt(this.textFontSize.get('value'));
      var font = new Font();
      font.setSize(size);
