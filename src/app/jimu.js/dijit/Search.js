...
function(declare, lang, html, array, on, string, _WidgetBase, _TemplatedMixin) {
  return declare([_WidgetBase,_TemplatedMixin], {
    ...
    templateString:
    '<div>'+
      '<span class="jimu-input-wrapper"><input class="jimu-input" data-dojo-attach-point="inputSearch" data-dojo-attach-event="onKeydown: _onKeyDown, onInput: _onInput"/></span>'+
