    ...
    return declare([_WidgetBase, _TemplatedMixin], {
      ...
      _createEditableTextTd: function(tr, fieldMeta, fieldData) {
        ...
        this.own(on(editableInput, 'blur', lang.hitch(this, function() {
          ...
          if (newValue !== '') {
            if (fieldMeta.unique) {
              var sameValueRows = this.getRowDataArrayByFieldValue(fieldMeta.name, newValue);
      ...
      _createActionsTd: function(tr, fieldMeta) {
        ...
        var actionItems = query(".action-item", td);
        var width = (20 * actionItems.length) + "px";
      ...
      getRowDataArrayByFieldValue: function(fieldName, fieldValue) {
        var result = [];
        if (!this.fields) {
          return [];
        }
