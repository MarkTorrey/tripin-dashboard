...
function(declare, array, lang, on, _WidgetBase, domConstruct, domClass, domAttr, utils) {
  return declare(_WidgetBase, {
    ...
    postCreate: function() {
      ...
      on(this.subNode, 'click', lang.hitch(this, function() {
        if(this.disabled){
          return;
        }
        var t = this.time;
      ...
      on(this.addNode, 'click', lang.hitch(this, function() {
        if(this.disabled){
          return;
        }
        var t = this.time;
      ...
      // }));
      on(this.timeInputNode, 'change', lang.hitch(this, function() {
      ...
      on(this.timeInputNode, 'focus', lang.hitch(this, function() {
        domClass.add(this.timeInputNode, 'focus');
      }));
      on(this.timeInputNode, 'blur', lang.hitch(this, function() {
        var t = utils.parseTime(this.timeInputNode.value);
        if(t < 0){
          this.timeInputNode.focus();
          return;
